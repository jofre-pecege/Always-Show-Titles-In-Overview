...
const Settings = GObject.registerClass({
    ...
    _renderUi() {
        ...
        this.group_by_app_switch = this._builder.get_object('group_by_app_switch');
...
export default class AlwaysShowTitlesInOverviewExtensionPreferences extends ExtensionPreferences {
    fillPreferencesWindow(window) {
        ...
        window.add(settings._builder.get_object('page_general'));
        window.add(settings._builder.get_object('page_titles'));
        window.add(settings._builder.get_object('page_icons'));
